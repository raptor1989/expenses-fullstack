...
import { getBudgets, createBudget, updateBudget, deleteBudget, getBudgetProgress } from '../services/budgetService';
...
export default function BudgetPage() {
    ...
    useEffect(() => {
        Promise.all([fetchCategories(), fetchBudgets()]).finally(() => {
            setLoading(false);
        });
    }, []);
                            ...
                            <Card>
                                <CardContent>
                                    ...
                                    >
                                        ...
                                        <Typography variant="h6">{formatCurrency(budget.amount)}</Typography>
                                    </Box>
                                ...
                                <CardActions>
                                    <Box sx={{ display: 'flex', justifyContent: 'flex-end', width: '100%' }}>
                                        <Tooltip title="Edit">
                                            <IconButton size="small" onClick={() => handleOpenEditDialog(budget)}>
